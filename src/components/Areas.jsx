export const Areas = () => {
    return (
        <>
            <div className="bg-white pb-[11.25rem] pt-[3.813rem]">
      <div className=" flex flex-col px-[10rem] mb-[2.625rem]">
          <div className=" self-center rounded-full h-[3.125rem] w-[3.125rem] bg-gradient-to-bl from-[#4361EE] to-[#4361EE00] mb-[5.063rem]"></div>
          <div className="flex flex-col mb-[5rem]">
              <p className="text-[#4361EE] text-[1.213rem] font-medium">AREAS ACROSS THE TOWN</p>
             ...
             <img className="object-cover h-[20rem] rounded-3xl flex-grow brightness-50 z-0 w-screen" src="https://s3-alpha-sig.figma.com/img/57f8/5829/4789792d8e3ff6ed2aa7b304fedf4612?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=X2yIOlXjQg3Wj8KQB7-eQvGv1uhXklmp93XVkSt3yEnDpPoPSM2LD6iObxkqzUTzQaAwpXKWrjWJvXZ1CfREczjvbuvBgIoRFksYjOx-T08FVoPcIt8-Fe-yQunw8PknY6LR1S2xSynES7rz~sX9Cdj4Kk9r8YSnOhesehkXwIcugIamTL0iD4ucEcAgqzO4LSOIdRs9bj28NayoDphKfe0FOSKePmWpj8JQKiZCBHHPYRjV8kAjo1z5XSjW1RwpNnxl-NQrE~koOuomDojE3gJXW~-WYub4yMS0Qv4ML~c~ji4p4czJracZ9AOCOFBW8iE3yoV0RBpN1g3haDHRow__" alt="" />
                ...
                <div className="Introduce flex flex-col px-[12.9rem]">
                    ...
                    <div className="flex gap-[4.188rem] justify-center">
                        <div className="w-[23%]">
                        <img className="object-cover h-[17.5rem] rounded-tl-[120px] rounded-3xl " src="https://s3-alpha-sig.figma.com/img/de87/1a6e/5ba179d3108c0fe0313f98e990f3c24e?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=KZZfuNGDKdO50wfw~olTJ8sPVd7SD~jdsUbwJpwCYfVlXOnrLzMNt772M8pfzr~AdjfLu7JIl9Qh0AYqS55WjZw7NjGuDCNfVawfFHdd4O3Tjs0N1TGYFNtuV75GkAnvQj2IdVbEZwjunSOTjKsRObLP-Goubu2yqKb9XpYjQ~wlynOUWeHCzCY6BbuIxCObZ~vXKaiVr8k5D6xJ3AM4FZT3m~dkusspfTeiMRYeFcHjTeyMF~u9W12GgktryiSGI0mjpEKXcUKIWJBxmZeAIdrTORveZyIOrrxJxpt~KET6QOCOBwMXzN8HQabA5mg5cw9BdUVXljJGfeERUg0hvQ__" alt="" />
                            <div className="mt-[1.875rem] text-center ">
                                <p className="text-[1.725rem] font-normal text-[#0B090A] mb-[1.875rem]">Brendon M</p>
                                <p className="text-[1rem] font-medium text-[#4361EE]">CEO & Founder</p>
                        </div>
                        </div>
                            
                        <div className="w-[24%]">
                            <img className="object-cover h-[17.5rem] rounded-tl-[120px] rounded-3xl " src="https://s3-alpha-sig.figma.com/img/a3da/74e8/4e8d08160f1e2d4fb6f3a584d79a10cb?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Ep1xdXhkUoIIbUiI0xWLINu8pic~AqvdwreRClqlZw2j0Oro3rvqxKvOLp-L~XhGDn~fCmvXXeR5~xPvupzxBw7WT2HCosn0rPuUwK6R1BrpTcYzfMZYy-8vJKvrixpyCfIqo-msSsZGzMLEjE8ahIG40IydlSS6f68FW3nGE1upqybPw0ytbKR0i6mnbN~Js64iPe3OAJ5CxYx-irOUw3-sdAWP49LaJlzmnY2JysSUq-uCPwd0jE7MkSv16cVse-wzzu0-Yy~PRFirCg4ySC~Dh1PYfQdUQNsEBSYTF0Vew7jeOpV4vwFg5De3UurM0kcxEn1XNWhBs3J7UlevSg__" alt="" />
                       
                            <div className="mt-[1.875rem] text-center ">
                                <p className="text-[1.725rem] font-normal text-[#0B090A] mb-[1.875rem]">Jodi J. Appleby</p>
                                <p className="text-[1rem] font-medium text-[#4361EE]">Real Estate Developer</p>
                        </div>
                        </div>

                        <div className="w-[24%]">
                            <img className="object-cover h-[17.5rem] rounded-tl-[120px] rounded-3xl" src="https://s3-alpha-sig.figma.com/img/617a/967d/58022bb707c2f752c723661e2519e1ce?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=NeifDrv3h5yCDK9cbEIPds52ORHB9SRK9RIpJUWJD1iAP3B-KLxZIXZiH6JqMDCASYRBQdrV8L8wceBVVMo36MPV7dP6Q5-LSl20yebowpq~foA7oJ9MSvFeeXoLPjiiyOvyCWDjw6tdadjYm~41P~4HJNRO10r3tQpvK6SK~20-7wrkofNsONacCGc7lTg3EOTmoLj3xeOD8a8IyQ0jEuGlhgyu~VuWVn7x5gljcvrDuTyF3H-hwh~gjUxtjMKNH0BOeuNOGaOrwU66W9F1qBrTLTn9enzTE6gGJIUNz5uNYYK5OFviklDB8LI0oL7IfeY5q-JHmL08fGdvcMTWng__" alt="" />
                            <div className="mt-[1.875rem] text-center ">
                                <p className="text-[1.725rem] font-normal text-[#0B090A] mb-[1.875rem]">Justin S. Meza</p>
                                <p className="text-[1rem] font-medium text-[#4361EE]">Listing Agent</p>
                        </div>
                        </div>

                        <div className="w-[24%]">
                            <img className="object-cover h-[17.5rem] rounded-tl-[120px] rounded-3xl" src="https://s3-alpha-sig.figma.com/img/7317/01ed/f5d85723e9c37fc2597b782a416f97d9?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=i6b2nz3mthTqF-RaHqQQSAL6mrHlK89410Zpi6UezC7pxvAXwV9AN7KL8RyJfFgf-WU0lTJH~TaObMwNiiH6NhBQy1Ln6Ojvz5dxvkkRy9aAGmQCCPiB5gUgKcVGtAOj8vx-7udQ~biqfClhB-aI4-crJXQKqJ98ExDICl55B5x1gXv3IL-BbIpxeuaq-hRkgGjwwEYeU6y9-9EZObEfpgqr-VeuErX6j4qJQT8DQbN5JI4B7fTkxecZZqvugv96zmsJq1yLQ~gzwFWGiv05GF0uEnZEH3ZBAOs8z1fli2hS3M9H1jsr7Y7xsY2Lmjo5pyd2Ryf5IrYkqLlrH7AFnQ__" alt="" />
                            <div className="mt-[1.875rem] text-center ">
                                <p className="text-[1.725rem] font-normal text-[#0B090A] mb-[1.875rem]">Susan T. Smith</p>
                                <p className="text-[1rem] font-medium text-[#4361EE]">Buyer's Agent</p>
                        </div>
                        </div>
                        </div>
                </div>
